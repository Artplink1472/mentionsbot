        ...
        for symbol in was_mentions:
            try:
                ...
                try:
                    ...
                    logger.info(f'!!!!!!!!4 message {e}!!!!!!!!')
                try:
                    if was_mentions[symbol]['Magic Eden']['floor'][0] != 'Just added' and (was_mentions[symbol]['Magic Eden']['floor'][-1]/was_mentions[symbol]['Magic Eden']['floor'][0]-1)*100/(mentions[symbol]['mentions'][-1]-was_mentions[symbol]['mentions'][0])>=3 and mentions[symbol]['mentions'][-1] >= 15:
