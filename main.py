    ...
    while True:
        ...
        for collection in new_collections:
            try:
                if collection['symbol'] not in was_mentions and collection['twitter']:
                    was_mentions[collection['symbol']]={"Magic Eden": {"twitter": '@'+collection['twitter'][collection['twitter'].rfind('/')+1:], "floor": ['Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added','Just added'], "listedCount": ["Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added"], "volume24hr": ["Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added"], "image": collection.get('image'), "min_pump_floor": 99999999, "max_floor": 0}, "mentions": ["Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added", "Just added"], "name": collection['name']}
            except Exception as e:
        ...
        async def start3(was_mentions):
            ...
            async with app_storage['session']:
                ...
                for symbol in was_mentions:
                    q+=1
                    tasks.append(asyncio.create_task(Magic_Eden_stats(symbol,proxies[q%len_proxies])))
                    if q%351==0:
        ...
        for symbol in was_mentions:
            try:
                ...
                if symbol not in sended_all:
                    ...
                    try:
                        if was_mentions[symbol]['Magic Eden']['floor'][0] != 'Just added' and 0<mentions[symbol]['Magic Eden']['volume24hr'][-1]/mentions[symbol]['Magic Eden']['volume24hr'][0]<=0.60 and mentions[symbol]['mentions'][0] >= 10 and was_mentions[symbol]['Magic Eden']['volume24hr'][0]>=50:
        ...
        if k%336==0:
            ...
            for symbol in was_mentions:
                if was_mentions[symbol]["Magic Eden"]['min_pump_floor']<99999999:
                    message+=f"{was_mentions[symbol]['name']}: call price - {was_mentions[symbol]['Magic Eden']['min_pump_floor']}, max price - {was_mentions[symbol]['Magic Eden']['max_floor']}\n"
